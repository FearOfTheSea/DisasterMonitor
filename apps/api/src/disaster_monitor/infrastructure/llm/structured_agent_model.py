...
class StructuredAgentModel:
    ...
    async def interpret(self, question: str) -> DisasterTaskDraft:
        ...
        prompt = (
            ...
            "This schema has no multi-hazard list: when a request names multiple "
            "disasters, do not invent a list or choose provider, source, or branch "
            "identities; deterministic application validation owns that routing. "
