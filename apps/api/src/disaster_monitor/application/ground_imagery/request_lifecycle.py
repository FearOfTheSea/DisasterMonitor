...
class GroundImageryRequestLifecycle:
    """Create, update, and resolve durable Ground imagery requests."""

    def __init__(
        self,
        context_reader: IncidentImageryContextReader,
        region_resolver: GroundImageryRegionResolver,
        catalog_searcher: GroundImageryCatalogSearcher,
        ...
        self._catalog_searcher = catalog_searcher
        self._store = store
