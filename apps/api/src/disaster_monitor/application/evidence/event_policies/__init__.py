...
from disaster_monitor.application.evidence.event_policies.default import (
    DefaultEventPolicy,
)
from disaster_monitor.application.evidence.event_policies.earthquake import (
    EarthquakeEventPolicy,
)
from disaster_monitor.application.evidence.event_policies.flood import FloodEventPolicy
from disaster_monitor.application.evidence.event_policies.volcanic_eruption import (
    VolcanicEruptionEventPolicy,
)
from disaster_monitor.application.evidence.event_policies.wildfire import (
    WildfireEventPolicy,
)
from disaster_monitor.application.evidence.event_resolution_core import EventPolicy
