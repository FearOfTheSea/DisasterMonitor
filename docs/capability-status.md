...
| OP     | Snapshots, history, workers, freshness, retention, backup tooling                 | Local operational checks passing | Pending rights, recovery, identity, and supervised-pilot evidence  |
...
resource orders remain unsupported.
